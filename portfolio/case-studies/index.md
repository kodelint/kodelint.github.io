...
<div class="p-container">
  ...
  <div class="p-section" style="padding-top: 1rem; padding-bottom: 5rem;">
    <div class="cs-stack">
      ...
      <div id="{{ case.id }}" class="cs-card">
        ...
        <div class="cs-card-summary">
          <p class="cs-context" style="margin-bottom: 1.5rem; font-weight: 600; color: var(--color-text-light);">{{ case.context }}</p>
          <div class="cs-block">
