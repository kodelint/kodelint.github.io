...
<div class="signature-section">
  ...
  <blockquote class="signature-quote">
    "I transpile <span class="tooltip-container">Caffeine<span class="tooltip-box"><b>Legal Performance Enhancers [drug]</b>The only fuel source compatible with my nervous system.</span></span> into <span class="tooltip-container">Spaghetti Code<span class="tooltip-box"><b>Job Security [concept]</b>If I can't read it, neither can the AI replacer.</span></span> and deploy <span class="tooltip-container">Hope<span class="tooltip-box"><b>Strategy [plan]</b>The primary scaling mechanism for 3AM deployments.</span></span> to production. My <span class="tooltip-container">Cloud Architecture<span class="tooltip-box"><b>Modern Art [noun]</b>Drawing expensive squares until the AWS bill arrives.</span></span> is just boxes connected by <span class="tooltip-container">Race Conditions<span class="tooltip-box"><b>Surprise Mechanics [feature]</b>Threading issues that only appear during important demos.</span></span>." <span style="color: var(--accent-primary);"> — That's Me!! </span>
  </blockquote>
</div>
