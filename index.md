...
<div class="hero-section">
  ...
  <div class="content-card info-card">
    ...
    <ul>
      ...
      <li>🚀 <strong>Mentorship</strong>: Teaching the next generation that 'Force Push' is a tool, not a lifestyle choice.</li>
    </ul>
  </div>
</div>
...
<div class="tech-graph">
  ...
  <div class="graph-commit feat">
    ...
    <div class="graph-content">
      ...
      <span class="graph-msg"><span class="type feat">feat</span> realized the <strong>Edge</strong> is just a server with a better view</span>
    </div>
  </div>
  <div class="graph-commit hotfix">
    ...
    <div class="graph-content">
      ...
      <span class="graph-msg"><span class="type hotfix">fix</span> learned that "cloud native" usually means "expensive native"</span>
    </div>
  </div>
  ...
  <div class="graph-commit feat">
    ...
    <div class="graph-content">
      ...
      <span class="graph-msg"><span class="type feat">feat</span> learned that 'Done' is better than 'Perfect', but 'Stable' is better than both</span>
    </div>
  </div>
  ...
  <div class="graph-commit merge">
    ...
    <div class="graph-content">
      <span class="graph-hash">bd36139</span>
      <span class="graph-msg"><span class="type merge">merge</span> successfully merged 15 sub-tasks without a single conflict (A Miracle)</span>
    </div>
  </div>
