...
cross_post_url: "https://medium.com/@email2sroy/Concepts-and-i-thought-i-knew-dns-c19b9e0cde39"
devto_url: "https://dev.to/deadlock/concept-and-i-thought-i-knew-dns-2kbe"
hashnode_url: "https://sroy.hashnode.dev/concept-and-i-thought-i-knew-dns"
toc: true
---
...
;; WHEN: Wed Jul 06 12:00:00 IST 2022
;; MSG SIZE  rcvd: 811
```
...
```text
www.google.com.  100 IN A 142.250.72.196
```
